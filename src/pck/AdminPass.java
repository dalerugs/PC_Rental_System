...
public class AdminPass extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int answer;
        answer = JOptionPane.showConfirmDialog(null, "Are you sure you want to change the Admin Password?","System Message",JOptionPane.YES_NO_OPTION);
        if(answer==JOptionPane.YES_OPTION){
            ...
            cn = (com.mysql.jdbc.Connection) DriverManager.getConnection(url, "root","");
            st = (com.mysql.jdbc.Statement) cn.createStatement();
             st.executeUpdate("UPDATE login SET Password = '"+newPass.getText()+"'Where name = 'admin' ");
